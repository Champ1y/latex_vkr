...
\AtBeginEnvironment{minted}{%
  ...
  \let\emph\@firstofone
  \def\PYGZdq{\char34\relax}%
}
\makeatother
\AtBeginEnvironment{Verbatim}{%
  \def\PYGZdq{\char34\relax}%
  \def\PYGZsq{\char39\relax}%
}
...
\newcommand*\VKR@physicalcenterpagenumber[1]{%
  \hbox to \textwidth{%
    \hspace*{\dimexpr .5\paperwidth - 1in - \hoffset - #1\relax}%
    \makebox[0pt][c]{\normalfont\fontsize{14pt}{14pt}\selectfont\thepage}%
    \hss}%
}
\def\ps@plain{%
  \let\@oddhead\@empty
  \let\@evenhead\@empty
  \def\@oddfoot{\VKR@physicalcenterpagenumber{\oddsidemargin}}%
  \def\@evenfoot{\VKR@physicalcenterpagenumber{\evensidemargin}}%
}
\pagestyle{plain}
