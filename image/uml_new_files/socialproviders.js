...
var mount=modalInstance.getMount(provider);if(!mount||mount.getAttribute("data-rendered")==="1"){return;}
mount.innerHTML="";mount.appendChild(makeProviderButton(provider,label,providerLogo(provider)));mount.setAttribute("data-rendered","1");if(typeof modalInstance.showProvider==="function"){modalInstance.showProvider(provider);}
